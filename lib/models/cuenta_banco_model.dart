...
class CuentaBancoModel {
  ...
  factory CuentaBancoModel.fromJson(String str) =>
      CuentaBancoModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory CuentaBancoModel.fromMap(Map<String, dynamic> json) =>
      CuentaBancoModel(
...
class RadioCuentaBancoModel {
  RadioCuentaBancoModel({
